const useCases = [
  {
    ...
    description: 'Create clean product photos with white or transparent backgrounds for your online store.',
    icon: (
  ...
  },
  {
    ...
    description: 'Isolate subjects for graphic design, collages, composites, and creative projects.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: 'Social Media',
    description: 'Make profile pictures, stories, and posts stand out with clean background removal.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Prepare images for banners, flyers, presentations, and marketing materials.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export default function BackgroundRemoverUseCases() {
  return (
