...
const features: Feature[] = [
  ...
  },
  {
    ...
    description: 'Instantly remove backgrounds with one click. Export with transparency.',
  ...
  },
  {
    ...
    description: 'Swap backgrounds with a prompt, solid color, or your own image.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Brush over unwanted objects and let AI clean them away naturally.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Convert images between JPG, PNG, and WebP. Batch convert up to 20 files at once.',
    href: '/converter',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Generate complete presentations with AI. Choose styles, preview slides, and download as PPTX or PDF.',
  ...
  {
    title: 'Download',
    description: 'Export as PNG or JPG at any quality and resolution you need.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
